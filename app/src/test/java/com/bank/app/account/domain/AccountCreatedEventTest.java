...
class AccountCreatedEventTest {
    ...
    void shouldThrowNullPointerExceptionWhenAccountIdIsNull() {
        assertThrows(NullPointerException.class,
                () -> new AccountCreatedEvent(null, 10L, "TR123", "User", Money.of("100.00", Money.Currency.TRY)));
    }

    @Test
    void shouldThrowNullPointerExceptionWhenUserIdIsNull() {
        assertThrows(NullPointerException.class,
                () -> new AccountCreatedEvent(1L, null, "TR123", "User", Money.of("100.00", Money.Currency.TRY)));
    }

    @Test
    void shouldThrowNullPointerExceptionWhenIbanIsNull() {
        assertThrows(NullPointerException.class,
                () -> new AccountCreatedEvent(1L, 10L, null, "User", Money.of("100.00", Money.Currency.TRY)));
    }

    @Test
    void shouldThrowNullPointerExceptionWhenOwnerNameIsNull() {
        assertThrows(NullPointerException.class,
                () -> new AccountCreatedEvent(1L, 10L, "TR123", null, Money.of("100.00", Money.Currency.TRY)));
    }

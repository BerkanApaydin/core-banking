...
class TransferCancelledEventTest {
    ...
    void shouldThrowNullPointerExceptionWhenTransferIdIsNull() {
        assertThrows(NullPointerException.class,
                () -> new TransferCancelledEvent(null, 10L, 20L, Money.of("100.00", Money.Currency.TRY)));
    }

    @Test
    void shouldThrowNullPointerExceptionWhenSenderAccountIdIsNull() {
        assertThrows(NullPointerException.class,
                () -> new TransferCancelledEvent(1L, null, 20L, Money.of("100.00", Money.Currency.TRY)));
    }

    @Test
    void shouldThrowNullPointerExceptionWhenReceiverAccountIdIsNull() {
        assertThrows(NullPointerException.class,
                () -> new TransferCancelledEvent(1L, 10L, null, Money.of("100.00", Money.Currency.TRY)));
    }

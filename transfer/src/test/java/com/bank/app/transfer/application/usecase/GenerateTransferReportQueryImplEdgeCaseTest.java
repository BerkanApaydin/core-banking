...
class GenerateTransferReportQueryImplEdgeCaseTest {
    ...
    @BeforeEach
    void setUp() {
        generateTransferReportUseCase = new GenerateTransferReportQueryImpl(
                loadTransferPort, new TransferViewEnricher(accountOperationPort), transferAuthorizationService, 100);
    }

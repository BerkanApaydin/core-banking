...
@DisplayName("AccountEventOutboxRelay")
class AccountEventOutboxRelayTest {
    ...
    private AccountEventOutboxRelay handler;
    ...
    void setUp() {
        ...
        handler = new AccountEventOutboxRelay(objectMapper, eventPublisher, idempotencyPort);
    }
    ...
    class Handle {
        ...
        void shouldThrowOnMalformedPayload() {
            ...
            assertTrue(ex.getMessage().contains("AccountEventOutboxRelay failed"));
            verify(eventPublisher, never()).publishEvent(any());
        }

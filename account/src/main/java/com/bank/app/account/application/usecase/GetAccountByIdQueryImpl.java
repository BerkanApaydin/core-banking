...
@ReadOnlyUseCase
public class GetAccountByIdQueryImpl implements GetAccountByIdQuery {

    private final LoadAccountPort loadAccountPort;
    private final AccountAuthorizationService accountAuthorizationService;

    public GetAccountByIdQueryImpl(LoadAccountPort loadAccountPort, AccountAuthorizationService accountAuthorizationService) {

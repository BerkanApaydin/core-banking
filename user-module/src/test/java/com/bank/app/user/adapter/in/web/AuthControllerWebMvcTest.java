...
class AuthControllerWebMvcTest {
    ...
    class Logout {
        ...
        @Test
        @DisplayName("should return 204 when called with valid Bearer token")
        void shouldReturn204WithBearerToken() throws Exception {
            ...
            verify(tokenBlacklistPort).blacklist("some-jwt-token", 3600000L);
        }

        @Test
        @DisplayName("should return 204 when header does not start with Bearer")
        void shouldReturn204WithNonBearerHeader() throws Exception {
            mockMvc.perform(post("/api/v1/auth/logout")

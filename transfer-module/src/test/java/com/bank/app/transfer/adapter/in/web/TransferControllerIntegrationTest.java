...
import com.bank.app.common.adapter.out.persistence.IdempotencyKeyJpaEntity;
import com.bank.app.common.adapter.out.persistence.IdempotencyKeyJpaRepository;
...
class TransferControllerIntegrationTest extends AbstractSpringBootIntegrationTest {
        ...
        void setUp() {
                ...
                u3Id = u3.getId();
                accountRepo.save(new AccountJpaEntity(null, u3Id, "TR290006200000000000000333", "Pasif",

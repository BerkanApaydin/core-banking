...
public class GetTransferDetailUseCaseDecorator implements GetTransferDetailPort {

    private final GetTransferDetailUseCase delegate;
    ...
    public GetTransferDetailUseCaseDecorator(
        ...
        this.delegate = new GetTransferDetailUseCase(loadTransferPort, accountOperationPort, securityContextPort);
    }

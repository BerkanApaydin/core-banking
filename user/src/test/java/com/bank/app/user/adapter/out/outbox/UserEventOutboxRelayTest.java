...
@DisplayName("UserEventOutboxRelay")
class UserEventOutboxRelayTest {
    ...
    private UserEventOutboxRelay handler;
    ...
    class Handle {
        ...
        void shouldThrowOnMalformedPayload() {
            ...
            assertTrue(ex.getMessage().contains("UserEventOutboxRelay failed"));
